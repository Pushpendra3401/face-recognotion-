...
known_face_names=[]
known_person1_image = face_recognition.load_image_file(r"person1.jpg")
...
known_person4_image = face_recognition.load_image_file("person4.jpg")
...
known_face_names.append("rajat")
known_face_names.append("moti")
known_face_names.append("Pushpendra")
known_face_names.append("annam")
